...
valueDec = valueDec - 1;
console.log("First decrementation (value - 1):", valueDec);
valueDec -= 1;
console.log("Second decrementation (value -= 1):", valueDec);
valueDec--;
console.log("Third decrementation (value --):", valueDec);
...
console.log("Random value between 2 and 7:", randomVal);
console.log("Round value:", Math.round(randomVal));
console.log("Floor (round down) value:", Math.floor(randomVal));
console.log("Ceil (round up) value:", Math.ceil(randomVal));
